...
<head>
    ...
    <style>
        ...
        .header { background-color: #1e293b; padding: 30px; text-align: center; border-bottom: 3px solid #2563eb; }
        ...
        .button { background-color: #2563eb; color: #ffffff; padding: 12px 25px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; font-size: 18px; box-shadow: 0 4px 10px rgba(37,99,235,0.5); transition: background-color 0.3s; }
