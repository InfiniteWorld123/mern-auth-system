...
<head>
  ...
  <style>
    ...
    .code-box { background-color: #4f46e5; color: #ffffff; padding: 15px 25px; font-size: 30px; font-weight: bold; border-radius: 8px; display: inline-block; letter-spacing: 3px; margin-bottom: 30px; box-shadow: 0 4px 10px rgba(79,70,229,0.5); }
