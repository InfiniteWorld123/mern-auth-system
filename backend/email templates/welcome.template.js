...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 0; font-size: 32px; color: #ffffff; font-weight: 700; }
        .content { padding: 40px; text-align: center; }
        .content h2 { color: #ffffff; font-size: 22px; margin-bottom: 15px; }
        .content p { color: #c9d1d9; font-size: 16px; line-height: 1.6; margin-bottom: 25px; }
        .button { background-color: #10b981; color: #ffffff; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 18px; display: inline-block; box-shadow: 0 4px 10px rgba(16,185,129,0.5); transition: background-color 0.3s; }
            ...
            <td style="padding: 20px 0;">
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Your account has been successfully activated, and we are thrilled to have you on board. You can now log in and start exploring all the features.</p>
